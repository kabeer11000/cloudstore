...
io.on("connection", function (socket) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        if (((_a = import.meta.env) !== null && _a !== void 0 ? _a : process.env).ENV === 'development')
            console.log("a device: ", socket.id, " has connected");
        socket.data.activeWatchables = new Set();
        socket.on(events_1.default.config.config(), function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2, socket.emit("config-cb", { _s: config_1.ServerVersion })];
        }); }); });
